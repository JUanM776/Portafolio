...
function Doll({ action }: { action: string }) {
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", alignItems:"center", width:72, gap:0 }}>
      ...
      >
        {/* Ojos */}
        <div style={{ position:"absolute", top:16, left:10, width:7, height:7,
          borderRadius:"50%", background:"#2a1a00" }} />
        <div style={{ position:"absolute", top:16, right:10, width:7, height:7,
          borderRadius:"50%", background:"#2a1a00" }} />
        {/* Brillo ojo izq */}
        <div style={{ position:"absolute", top:17, left:13, width:2.5, height:2.5,
          borderRadius:"50%", background:"white" }} />
        <div style={{ position:"absolute", top:17, right:13, width:2.5, height:2.5,
          borderRadius:"50%", background:"white" }} />
        {/* Boca */}
        <div style={{ position:"absolute", bottom:11, left:"50%", transform:"translateX(-50%)",
          width:14, height:6, borderRadius:"0 0 8px 8px",
          border:"2px solid #2a1a00", borderTop:"none", background:"transparent" }} />
        {/* Cabello */}
        <div style={{ position:"absolute", top:-4, left:4, right:4, height:14,
      ...
      <div style={{ display:"flex", alignItems:"flex-start", justifyContent:"center", position:"relative" }}>
        ...
        >
          <div style={{ width:11, height:28, background:"linear-gradient(180deg,#2563eb,#1d4ed8)",
            borderRadius:"6px 6px 4px 4px" }} />
          {/* Mano */}
          <div style={{ width:13, height:13, borderRadius:"50%",
            background:"#f5d78e", border:"1.5px solid #c4983e", marginTop:-2 }} />
        </motion.div>
        ...
        >
          ...
          <div style={{ position:"absolute", top:8, left:"50%", transform:"translateX(-50%)",
            width:12, height:9, border:"1.5px solid rgba(255,255,255,0.3)",
            borderRadius:3 }} />
        </div>

        {/* Brazo derecho */}
        <motion.div
          animate={isWalk ? {rotate:[-25,25,-25], transition:{duration:0.45,repeat:3}}
            : {rotate:-12}}
          style={{ display:"flex", flexDirection:"column", alignItems:"center",
            transformOrigin:"top center", marginTop:6, marginLeft:-3 }}
        >
          <div style={{ width:11, height:28, background:"linear-gradient(180deg,#2563eb,#1d4ed8)",
            borderRadius:"6px 6px 4px 4px" }} />
          <div style={{ width:13, height:13, borderRadius:"50%",
      ...
      <div style={{ display:"flex", gap:4, marginTop:1 }}>
        ...
        >
          <div style={{ width:14, height:34, background:"linear-gradient(180deg,#1e3a5f,#162d4a)",
            borderRadius:"3px 3px 2px 2px" }} />
          {/* Zapato */}
          <div style={{ width:18, height:9, background:"#1a1a1a",
            borderRadius:"2px 4px 4px 2px", marginTop:-2, marginLeft:2 }} />
        </motion.div>
        <motion.div
          animate={isWalk ? {rotate:[-28,28,-28], transition:{duration:0.45,repeat:3}}
            : isJump ? {y:[0,-14,0], transition:{duration:0.4}} : {rotate:0}}
...
export default function AvatarGuide() {
  ...
  const actionRef             = useRef("idle"); // ref para evitar stale closures
