...
const CONTACT_ICONS = [
  {
    ...
    labelOverride: "Email",
    value: "juanmaflorez7@gmail.com",
    href: "mailto:juanmaflorez7@gmail.com",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="lg:col-span-2 border border-[var(--border)] bg-[var(--surface)]/60 backdrop-blur-sm rounded-xl p-6">
            ...
            <div className="flex flex-col gap-3">
              {CONTACT_ICONS.map(({ labelKey, labelOverride, value, href, icon }) => (
                <a key={labelKey} href={href} target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 p-3 rounded-lg hover:bg-[#0d1a14] transition-colors duration-200">
                  <span className="text-[var(--accent)] group-hover:scale-110 transition-transform duration-200">{icon}</span>
                  <div className="flex flex-col">
                    <span className="text-[9px] tracking-widest uppercase font-medium" style={{ color: "var(--text-muted)" }}>{labelOverride || t(labelKey)}</span>
